...
//                     <td data-label="Created At">{new Date(farmer.created_at).toLocaleString()}</td>
//                     <td data-label="Modified By">{farmer.modified_by || '-'}</td>
//                     <td data-label="Modified At">{farmer.modified_at ? new Date(farmer.modified_at).toLocaleString() : '-'}</td>
//                   </tr>
//                 ))
//               ) : (
              ...
              {currentFarmers.length > 0 ? (
                currentFarmers.map((farmer) => (
                  ...
                  >
                    <td data-label="Farmer ID">{farmer.fr_farmer_id}</td>
                    <td data-label="Full Name">{farmer.fr_full_name}</td>
                    <td data-label="Created At">{formatApiDate(farmer.created_at)}</td>
                    <td data-label="Modified By">{farmer.modified_by || '-'}</td>
                    <td data-label="Modified At">{formatApiDate(farmer.modified_at)}</td>
                  </tr>
                ))
              ) : (
