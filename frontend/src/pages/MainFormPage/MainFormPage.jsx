      ...
      try {
        ...
        const keycloakPayload = {
          ...
          credentials: [
            {
              type: "password",
              value: formattedPassword, // e.g., dob
              temporary: false,
            },
          ],
          attributes: {
          ...
          Modal.success({
            ...
            content: (
              <div>
                ...
                <p>
                  Your credentials will be shared with you once your
                  registration is approved. An SMS will be sent to your
                  registered mobile number.
                </p>
                <p>
                  <strong>Password Format Hint:</strong> Your DOB in this
                  format: <code>{passwordFormatHint}</code>
                </p>
              </div>
            ),
            okText: "Close",
