  ...
  return (
    <Card title={<Title level={4}>Land Details</Title>}>
      <div className="land-form-container">
        ...
        {(availableLands.length > 0 || fetchingLands || (!fetchingLands && Object.keys(landLocation).length > 0)) && (
          <Spin spinning={fetchingLands} tip="Loading lands...">
            <div className="available-lands-section">
              <Divider orientation="left">Available Lands at Selected Location</Divider>

              {landsFetched && !fetchingLands && availableLands.length === 0 && (
                <div style={{ marginTop: 16, marginBottom: 16, color: '#ff4d4f', fontWeight: 500 }}>
                  No registered lands found at the selected location under your name.
                </div>
              )}
